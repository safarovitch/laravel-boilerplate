...
<head>
    ...
    <script>
        window.hs_config = {
            ...
            "skipFilesFromBundle": {
                "dist": [
                    "{{ asset('/js/hs.theme-appearance.js') }}",
                    "{{ asset('/js/hs.theme-appearance-charts.js') }}",
                    "{{ asset('/js/demo.js') }}"
                ],
                "build": [
                    "{{ asset('/css/theme.css') }}",
                    "{{ asset('/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside-mini-cache.js') }}",
                    "{{ asset('js/demo.js') }}",
                    "{{ asset('css/theme-dark.css') }}",
                    "{{ asset('css/docs.css') }}",
                    "{{ asset('vendor/icon-set/style.css') }}",
                    "{{ asset('js/hs.theme-appearance.js') }}",
                    "{{ asset('js/hs.theme-appearance-charts.js') }}",
