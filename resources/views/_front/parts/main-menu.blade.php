                            ...
                            <nav class="department-nav-menu">
                                ...
                                <ul class="nav-menu-list">
                                    <li>
                                        <a href="#" class="nav-link has-megamenu">
                                            <span class="menu-icon"><img
                                                    src="{{asset('_front/assets/images/product/categories/cat-01.png')}}"
                                                    alt="Department"></span>
                                                ...
                                                <div class="featured-product">
                                                    ...
                                                    <div class="product-list">
                                                        <div class="item-product">
                                                            <a href="#"><img
                                                                    src="{{asset('_front/assets/images/product/product-feature1.png')}}"
                                                                    alt="Featured Product"></a>
                                                        </div>
                                                        <div class="item-product">
                                                            <a href="#"><img
                                                                    src="{{asset('_front/assets/images/product/product-feature2.png')}}"
                                                                    alt="Featured Product"></a>
                                                        </div>
                                                        <div class="item-product">
                                                            <a href="#"><img
                                                                    src="{{asset('_front/assets/images/product/product-feature3.png')}}"
                                                                    alt="Featured Product"></a>
                                                        </div>
                                                        <div class="item-product">
                                                            <a href="#"><img
                                                                    src="{{asset('_front/assets/images/product/product-feature4.png')}}"
                                                                    alt="Featured Product"></a>
                                                        </div>
                                                    </div>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link has-megamenu">
                                            <span class="menu-icon"><img
                                                    src="{{asset('_front/assets/images/product/categories/cat-02.png')}}"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link has-megamenu">
                                            <span class="menu-icon"><img
                                                    src="{{asset('_front/assets/images/product/categories/cat-03.png')}}"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link">
                                            <span class="menu-icon"><img
                                                    src="{{asset('_front/assets/images/product/categories/cat-04.png')}}"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link">
                                            <span class="menu-icon"><img
                                                    src="{{asset('_front/assets/images/product/categories/cat-05.png')}}"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link">
                                            <span class="menu-icon"><img
                                                    src="{{asset('_front/assets/images/product/categories/cat-06.png')}}"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link">
                                            <span class="menu-icon"><img
                                                    src="{{asset('_front/assets/images/product/categories/cat-07.png')}}"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link">
                                            <span class="menu-icon"><img
                                                    src="{{asset('_front/assets/images/product/categories/cat-08.png')}}"
                                                    alt="Department"></span>
                        ...
                        <nav class="mainmenu-nav">
                            ...
                            <div class="mobile-nav-brand">
                                <a href="index.html" class="logo">
                                    <img src="{{asset('_front/assets/images/logo/logo.png')}}" alt="Site Logo">
                                </a>
                            </div>
                            <ul class="mainmenu">
