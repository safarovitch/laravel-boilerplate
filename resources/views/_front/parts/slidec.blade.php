                        ...
                        <div class="slider-activation-one axil-slick-dots">
                            <div class="single-slide slick-slide">
                                ...
                                <div class="main-slider-thumb">
                                    <img src="{{asset('_front/assets/images/product/product-40.png')}}" alt="Product">
                                </div>
                            </div>
                            <div class="single-slide slick-slide">
                                <div class="main-slider-content">
                                ...
                                <div class="main-slider-thumb">
                                    <img src="{{asset('_front/assets/images/product/product-46.png')}}" alt="Product">
                                </div>
                            </div>
                            <div class="single-slide slick-slide">
                                <div class="main-slider-content">
                    ...
                    <div class="slider-product-box">
                        <div class="product-thumb">
                            <a href="single-product.html">
                                <img src="{{asset('_front/assets/images/product/product-41.png')}}" alt="Product">
                            </a>
                        </div>
